...
export default defineComponent({
  ...
  setup (props, context) {
    const innerValue = ref<string>(props.defaultValue || _get(props.form.values.value, `${props.name}`, null))
    ...
    watch(() => innerValue.value, (n, o) => {
      if (!_isEqual(n, o)) {
        ...
        props.form.repo.updateAttr(props.form.formName, props.name, newRawValue ? +newRawValue : newRawValue)
      }
    })
