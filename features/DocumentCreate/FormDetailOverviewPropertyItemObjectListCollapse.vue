<template>
  <fragment>
    <Modal
        ...
        :isHideHeader="true"
        :value="isShowModal">
      <FormDetailOverviewPropertyItemObjectListCollapseModal
          @close="onModalClose"
          @submit="onModalClose"
          :label="label"
          :value="value"
...
import FormDetailOverviewPropertyItemObjectListCollapseModal
  from "~/features/DocumentCreate/FormDetailOverviewPropertyItemObjectListCollapseModal.vue";
