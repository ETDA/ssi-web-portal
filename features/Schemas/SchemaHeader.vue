<template>
  <div class="table-header d-flex flex-wrap pt-3 px-5 pb-5 justify-content-between">
    <div class="d-flex align-items-center mb-3 mb-sm-0">
      ...
      <div v-if="isEndpoint" class="form-group pl-2 mb-0">
        <label for="select" class="input-label">Schema Endpoint</label>
        <div class="input-group input-group-merge">
          <select
    ...
    <div
      class="d-flex align-items-center justify-content-end pt-0 mt-0 pt-sm-4 mt-sm-1"
    >
...
export default defineComponent<Props>({
  ...
  setup(props: Props, context) {
    ...
    let order = ref<string>("acs")
    let endpoint = ref<string>("ทั้งหมด")
    let isEndpoint = props.isEndpoint
