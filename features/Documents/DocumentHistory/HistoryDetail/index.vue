...
import Detail from '~/features/Documents/DocumentHistory/HistoryDetail/Detail.vue'
import Header from '~/features/Documents/Header.vue'

interface Props {}

export default defineComponent<Props>({
  components: { DocumentButton, Detail, Header },
  props: {},
  setup (props: Props, context) {
    ...
    onMounted(() => {
      if (route.value.query.tab) {
        tabActiveIndex.value = route.value.query.tab === 'CertifiedPaper' ? 1 : 0
      }
    })
